          ...
          <div class="tab-content myaccount-tab-content" id="account-page-tab-content">
            <div class="tab-pane fade show active" id="account-details" role="tabpanel" aria-labelledby="account-details-tab">
              <div class="myaccount-details">
                <form class="sf-form" action="goodsUpdate.do" onsubmit="return check();"  method="post"  enctype="multipart/form-data" ><!-- enctype="multipart/form-data" -->
                  <div class="sf-form-inner">
                    <div class="single-input single-input-half">
                      <label >商品名*</label>
                      <input type="text" name="name" id="username" required="required" placeholder="商品名"value="${goods.name}" >
                      <input type="hidden" name="id" required="required"value="${goods.id}" >
                    ...
                    <div class="single-input single-input-half">
                      ...
                      <select name="fid">
                        <c:forEach items="${tlist}" var="t">
                          <option value="${t.id}" <c:if test="${t.id==goods.fid}">selected  </c:if>>${t.name}</option>
                        </c:forEach>
                      </select>
                    </div>
                    <div class="single-input single-input-half">
                    ...
                    <div class="single-input single-input-half">
                      <label >单价*</label>
                      <input type="text" name="price" id="txtPhone"  required="required"  value="${goods.price}">
                      <span id='prompt_phone' class="spanInit" ></span>
                    </div>
                    <div class="single-input ">
                      <label >商品详情</label>
                      <textarea name="note" id="editor_id" style="width:100%;height:200px;"  placeholder="请输入说明" class="layui-textarea">${goods.note}</textarea>
                    </div>
                    <div class="single-input">
