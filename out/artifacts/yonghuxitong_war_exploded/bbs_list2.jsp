		...
		<main class="page-content">
			...
			<div class="wishlist-page-area section-padding-lg bg-white">
				<div class="container">
					...
					<div><a href="addBbs.jsp" class="sf-button sf-button-dark">发布建议留言</a></div>
					<!-- 下面写内容 -->
					...
					<%-- 	<table class="table table-bordered table-hover">
							<thead>
								<tr>			
									...
									<th class="cart-column-productname" scope="col">建议留言内容</th>
							...
							<tbody>
								...
								<tr><td colspan="6"><a href="addBbs.jsp">发布建议留言</a></td></tr>
