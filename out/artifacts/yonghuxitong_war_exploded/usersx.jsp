            ...
            <div class="container">
				<div class="sf-breadcrumb">
					<ul>
						...
						<li><a href="usersListFore.do">商家信息</a></li>
						<li>${users.tname }</li>
					</ul>
				</div>
            </div>
		...
		<main class="page-content">
            ...
            <div class="product-page-wrapper section-padding-lg">
                <div class="container">
                    ...
                    <div class="row product-details">
						...
						<div class="col-lg-5 col-md-6">
							<div class="product-details-left">
								<div class="product-details-images slider-navigation-2">
									<a href="upload/${users.img }">
										<img src="upload/${users.img }" alt="product image" width="470px;" height="624px;">
									</a>
							...
							<%-- 	<div class="product-details-thumbs slider-navigation-2">										
									<img src="upload/${users.img }" alt="product image thumb"  width="105px" height="140px;">
                        ...
                        <div class="col-lg-7 col-md-6">
							<div class="product-details-right">
								<h5 class="product-title">${users.tname }</h5>
								...
								<%--	<span class="stock-available">订单量：${users.xnum }</span>--%>
								</div>
								<p></p>
								
								<span class="pricebox"><!-- <del>$60.00</del>  --><%--￥：${users.price }--%></span>
                 ...
                 <%-- <c:if test="${sessionScope.user!=null }">
                    <a href="doAddBbs.do?gid=${users.uid }" class="sf-button sf-button-sm">
                      <span>建议留言</span>
                    </a>
                  </c:if>--%>
								</div>
                ...
                <div class="product-details-color">
                  ...
                  <ul>
                    ...
                    <div class="product-descripton-review">
                        ...
                        <li class="nav-item">
                                <a class="nav-link" id="product-reviews-tab" data-toggle="tab" href="#product-reviews" role="tab" aria-controls="product-reviews" aria-selected="false">查看商家商品</a>
                            </li>
                        </ul>
                                      ...
                                      <c:forEach items="${slist}" var="u">
                                        <div class="single-comment">
                                          <div class="single-comment-thumb">
                                            <%--<c:forEach items="${slist}" var="u">--%>
                                                <a href="showGoodsx.do?id=${u.id}"><img src="upload/${u.img}" width="100px;"></a>
                                           <%-- </c:forEach>--%>
                                          ...
                                          <div class="single-comment-content">
                                            ...
                                            <%--  <h6><c:forEach items="${ulist}" var="u">
                                              ...
                                              <a href="showGoodsx.do?id=${u.id}">${u.name};价格：${u.price}</a>
                                              <div class="ratting-box">
                                               <%-- <span class="active"><i class="ti ti-star"></i></span>
                                                <span class="active"><i class="ti ti-star"></i></span>
                                                <span class="active"><i class="ti ti-star"></i></span>
