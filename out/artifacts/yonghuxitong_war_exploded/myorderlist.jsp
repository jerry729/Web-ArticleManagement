      ...
      <div class="cart-table table-responsive">
        ...
        <table class="layui-table table table-bordered table-hover" lay-filter="mylist" lay-size="lg">
          ...
          <tr>
            ...
            <th lay-data="{field:'ly',align:'center', minWidth:100}">数量</th>
          ...
          <c:forEach items="${list }" var="o">
            ...
            <tr>
              ...
              <td>${o.status }</td>
              <td>
                <a href="showOrder.do?id=${o.kid }" class="btn btn-info">查看</a>
                ...
                <a href="shouHuo.do?id=${o.kid }" class="btn btn-info">收货</a>
                </c:if>
                <c:if test="${o.status=='已退货，退款' }">
                <a href="deleteForderF.do?id=${o.kid }" class="btn btn-info">删除</a>
                </c:if>
                <c:if test="${o.status=='已收货'||o.status=='待评价' }">
                <a href="doAddOrderPj.do?id=${o.kid }" class="btn btn-info">评价</a>
                </c:if>
