					...
					<div class="row">
						...
						<div class="col-lg-8">
							<div class="commentbox">
								<h3 class="small-title">修改地址</h3>
								<form id="contact-form" action="updateSite.do" method="POST" class="sf-form contact-form">
									<div class="sf-form-inner mt-0">
										<div class="single-input ">
											<label for="new-review-name">地址*</label>
											<input type="text" name="name" id="new-review-name" value="${site.name}" required="required">
