                        ...
                        <div class="col-lg-7 col-md-6">
							<div class="product-details-right">
								...
								<div class="ratting-stock-availbility">
									...
									<%--<span class="stock-available">数量：${goods.xnum }</span>--%>
								</div>
								<p></p>
								
								<span class="pricebox"><!-- <del>$60.00</del>  -->积分：${goods.price }</span>
									...
									<!-- <div class="quantity-select">
									 ...
									 <c:if test="${sessionScope.user!=null }">
                                         <c:if test="${sessionScope.user.id!=goods.uid}">
                                             <a href="addRecord.do?gid=${goods.id }" class="sf-button sf-button-sm">
                                                 <span>兑换</span>
                                             </a>
                                         </c:if>
									...
									<ul>
										<li><c:forEach items="${ulist }" var="a">
												<c:if test="${a.id==goods.uid }">
													<img src="upload/${a.img}" height="50px;" width="50px;">${a.tname }
