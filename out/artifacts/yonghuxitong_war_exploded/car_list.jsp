			...
			<div class="wishlist-page-area section-padding-lg bg-white">
				<div class="container">
					...
					<div class="cart-table table-responsive">
						...
						<li style="    margin-top: 10px;">预订单金额：<label ><input type="text" name="zprice" id="total" readonly="readonly" style="width:100px"/>元 </label>
						<li style="    margin-top: 10px;">
						<input name="id" type="hidden"  value="${sessionScope.user.id }"  />
						</li>
              <li style="    margin-top: 10px;">收货地址：
                <select name="dzid">
              ...
              <li style="margin-top: 10px;">
						<input name="button" type="submit" id="button" class="btn btn-warning" value="确认"  /></li>
						</ul>
						</div>
						</form>
						</td>
