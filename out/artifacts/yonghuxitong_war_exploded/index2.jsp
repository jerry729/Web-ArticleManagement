						...
						<div class="row align-items-center justify-content-center">
							...
							<div class="col-xl-6 col-lg-5 col-md-5 col-sm-6 order-1 order-md-2 align-self-end">
								<div class="hero-image">
									<img src="./upload/${n.img }" alt="hero image" width="600px;" height="500px;">
								</div>
							</div>
						</div>
					</div>
							...
							<div class="blog-item">
								...
								<div class="blog-item-content">
									<div class="blog-item-content-inner">
										<span class="blog-item-author">By: <a href="showGoodsx.do?id=${n2.id }">admin</a></span>
										<h6 class="blog-item-title"><a href="showGoodsx.do?id=${n2.id }">${n2.name } </a></h6>
										<p></p>
										<div class="blog-item-meta">
											<span>${n2.pubtime }</span>
											<span>积分：${n2.price}</span>
											<span><a href="#"></a></span>
										</div>
										<a href="goodsListFore.do" class="sf-button sf-button-transparent sf-button-sm">
											<span>查看更多</span>
										</a>
									</div>
								</div>
