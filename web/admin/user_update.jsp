...
<div id="app">
  ...
  <div class="main">
    ...
    <div class="right p20">
      ...
      <form class="layui-form h" action="updateUser.do" method="post" enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline">
            <input type="password"  id="pwd"  onblur="return checkPwd()" value="${user.pwd}" placeholder="请输入密码" autocomplete="off" class="layui-input">
          </div>
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline">
            ...
            <c:if test="${user.sex!='男'}">
              <input type="radio" name="sex"   autocomplete="off" class="layui-input" value="男" > 男
              <input type="radio" name="sex"   autocomplete="off" class="layui-input" value="女" checked > 女
            </c:if>
