...
public class Info {
	...
	public static String FILEPATH = "D:\\workspace\\gaoxiaohouqin\\src\\main\\webapp\\upload\\";
	public static String FILEPATH2 = "D:\\workspace\\zhuanyezhishiku\\src\\main\\webapp\\upload\\";
	...
	{
	System.out.print(-Info.getBetweenDayNumber("2019-05-01", "2019-04-04 11:11"));
	}
	  ...
	  public static String tform(HashMap map)
		{
	    	...
	    	Set set = map.entrySet();
	    	 ...
	    	 jscode+=" if(f1."+str1+")\n";
	    	  ...
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt3\").src=\"/pianotrainwebstie/upfile/"+map.get("filename3")+"\";\n";
	    	  jscode+="}\n";

	    	  jscode+="if(document.getElementById(\"txt4\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt4\").src=\"/pianotrainwebstie/upfile/"+map.get("filename4")+"\";\n";
	    	  jscode+="}\n";

	    	  jscode+="if(document.getElementById(\"txt5\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt5\").src=\"/pianotrainwebstie/upfile/"+map.get("filename5")+"\";\n";
	    	  jscode+="}\n";
	...
	public static String fck(int height,String content)
	{
		...
		jscode+="<script type=\"text/javascript\"  src=\"/pianotrainwebstie/fckeditor/fckeditor.js\"></script>";
	...
	public  static  String fileUpload2(@RequestParam(value = "file2", required = false) MultipartFile file,
                                       HttpServletRequest request, String img) {
		String path = request.getSession().getServletContext().getRealPath("upload");
		System.out.println("path===" + path);
		System.out.println("file===" + file);
