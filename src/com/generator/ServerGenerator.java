...
public class ServerGenerator {
    ...
    static String MODULE = "src\\com\\";
    public static String DB_TABLE="yonghuxitong";
    static String toDaoPath = MODULE+"dao\\";
    static String toServerPath = MODULE+"server\\";
    static String toServerImplPath = MODULE+"server\\impl\\";
    static String toControllerPath = MODULE+"controller\\admin\\";
    //static String toControllerPath = MODULE+"\\src\\main\\java\\com\\course\\"+MODULE+"\\controller\\admin\\";
   public static String generatorConfigPath = "src\\com\\generator\\generatorConfig.xml";
    ...
    public static void main(String[] args) throws Exception {
       ...
       /* String Domain="Section";
        ...
        /*生成server*/
        FreemarkerUtil.initConfig("server.ftl");
        FreemarkerUtil.generator(toServerPath+Domain+"Server.java",map);

        /*生成serverImpl*/
        FreemarkerUtil.initConfig("serverImpl.ftl");
        FreemarkerUtil.generator(toServerImplPath+Domain+"ServerImpl.java",map);
